...
#define SHARED_NONSECURE_SIZE (8 * FWK_KIB)

/* SCMI Non-Secure Payload Areas */
#define SCMI_PAYLOAD0_NS_A2P_BASE (SHARED_NONSECURE_BASE)
#define SCMI_PAYLOAD0_NS_A2P_VMM  (SCMI_PAYLOAD0_NS_A2P_BASE + SHARED_NONSECURE_SIZE * 1)
#define SCMI_PAYLOAD0_NS_A2P_VM1  (SCMI_PAYLOAD0_NS_A2P_BASE + SHARED_NONSECURE_SIZE * 2)
#define SCMI_PAYLOAD0_NS_A2P_VM2  (SCMI_PAYLOAD0_NS_A2P_BASE + SHARED_NONSECURE_SIZE * 3)
