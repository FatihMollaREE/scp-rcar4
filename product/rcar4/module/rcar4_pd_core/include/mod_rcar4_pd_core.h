...
#ifndef MOD_RCAR4_PD_CORE_H
#define MOD_RCAR4_PD_CORE_H
...
/*!
 * \defgroup GroupRCAR4PdCore PD Core
 * @{
 */
 ...
 */
enum mod_rcar4_ps_sysc_api_idx {
    /*! Power domain driver API */
    MOD_RCAR4_PD_SYSC_API_IDX_POWER_DOMAIN_DRIVER,
    /*! interrupt Service Routine driver API */
    MOD_RCAR4_PD_SYSC_API_IDX_ISR,
    /*! System boot API */
    MOD_RCAR4_PD_SYSC_API_IDX_BOOT,
    /*! Number of exposed interfaces */
    MOD_RCAR4_PD_SYSC_API_IDX_COUNT,
};

/*!
 * \brief Power domain descriptor.
 */
struct mod_rcar4_pd_sysc {
 ...
 */
struct mod_rcar4_pd_core_config {
 ...
 */
struct mod_rcar4_pd_core_pd_config {
    /*! Power domain type */
    enum rcar4_pd_type pd_type;

    /*! descriptor */
    struct mod_rcar4_pd_sysc ppu;
 ...
 */
struct mod_rcar4_pd_sysc_power_state_observer_api {
    /*!
...
struct rcar4_pd_sysc_pd_ctx {
    /* Power domain configuration data */
    const struct mod_rcar4_pd_core_pd_config *config;
    ...
    struct rcar4_pd_sysc_pd_ctx *parent_pd_ctx;

    /* Pointer to the power state observer API */
    const struct mod_rcar4_pd_sysc_power_state_observer_api *observer_api;
...
struct rcar4_pd_sysc_cluster_pd_ctx {
    /*
     * Table of pointers to the contexts of the cores being part of the
     * cluster.
     */
    struct rcar4_pd_sysc_pd_ctx *core_pd_ctx_table[CORE_PER_CLUSTER_COUNT_MAX];
...
/* Module context */
struct rcar4_pd_sysc_ctx {
    /* Table of the power domain contexts */
    struct rcar4_pd_sysc_pd_ctx *pd_ctx_table;
