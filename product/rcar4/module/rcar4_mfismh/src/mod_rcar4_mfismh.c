...
struct mfismh_device_ctx {
    ...
    const struct mod_rcar4_mfismh_device_config *config;
...
static int mfismh_device_init(
    ...
    const void *data)
{
    struct mod_rcar4_mfismh_device_config *config =
        (struct mod_rcar4_mfismh_device_config *)data;
    struct mfismh_device_ctx *device_ctx;
...
const struct fwk_module module_rcar4_mfismh = {
