...
#ifndef MOD_RCAR4_PD_SYSC_H
#define MOD_RCAR4_PD_SYSC_H
...
/*!
 * \defgroup GroupRCAR4PdSysc SYSC Driver
 * @{
 */
...
struct rcar4_sysc_pd_ctx {
    /* Power domain configuration data */
    const struct mod_rcar4_pd_sysc_config *config;
 ...
 */
struct mod_rcar4_pd_sysc_config {
    /*! Power domain type */
