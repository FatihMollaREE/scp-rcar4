...
#include <config_power_domain.h> // Fatih: das implementieren
...
static const struct fwk_element transport_element_table[] = {
    ...
    { .name = "PSCI",
      .data = &((struct mod_transport_channel_config){
          ...
          .driver_id = FWK_ID_SUB_ELEMENT_INIT(
              FWK_MODULE_IDX_RCAR4_MFISMH,
              RCAR4_MFISMH_DEVICE_IDX_S,
              0),
          .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_MFISMH, 0),
      }) },
    ...
    { .name = "VM2",
      .data = &((struct mod_transport_channel_config){
          ...
          .driver_id = FWK_ID_SUB_ELEMENT_INIT(
              FWK_MODULE_IDX_RCAR4_MFISMH,
              RCAR4_MFISMH_DEVICE_IDX_NS_4,
              0),
          .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_MFISMH, 0),
      }) },
    [RCAR4_SCMI_SERVICE_IDX_COUNT] = { 0 },
};
