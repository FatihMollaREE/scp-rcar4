...
#include <config_rcar4_pd_sysc.h>
#include <config_rcar4_pd_core.h>
...
static const struct mod_power_domain_config rcar4_power_domain_config = { 0 };

static struct fwk_element rcar4_power_domain_static_element_table[] = {
    [CONFIG_POWER_DOMAIN_CHILD_A3IR] = {
        .name = "a3ir",
        .data = &((struct mod_power_domain_element_config){
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_A3IR),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
    ...
    [CONFIG_POWER_DOMAIN_CHILD_3DGE] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_3DGE),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_3DGD] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_3DGD),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_3DGC] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_3DGC),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_3DGB] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_3DGB),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_3DGA] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_3DGA),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_A2VC1] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_A2VC1),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_A3VC] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_A3VC),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_CR7] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_CR7),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    [CONFIG_POWER_DOMAIN_CHILD_A3VP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_SYSC, RCAR4_PD_SYSC_ELEMENT_IDX_A3VP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
    ...
    /* fatih: kann sein, dass dieses "disabled" dazu führt das die hierrauf folgenden indexe nichtmehr passen die müsste man dementsprechend anpassen
    [CONFIG_POWER_DOMAIN_CHILD_DDR_BKUP] = {
        .name = "pmic_ddr_bkup",
        .data = &((struct mod_power_domain_element_config) {
            .attributes.pd_type = MOD_PD_TYPE_DEVICE,
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_RCAR4_PD_PMIC_BD9571,
                RCAR4_PD_PMIC_ELEMENT_IDX_PMIC_DDR_BKUP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_PMIC_BD9571,
                MOD_RCAR4_PD_PMIC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
        }),
    ...
    [CONFIG_POWER_DOMAIN_CHILD_ALWAYS_ON] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .driver_id = FWK_ID_ELEMENT_INIT(
                ...
                RCAR4_PD_SYSC_ELEMENT_IDX_ALWAYS_ON),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_RCAR4_PD_SYSC,
                MOD_RCAR4_PD_SYSC_API_TYPE_PUBLIC),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
 ...
 */
static const struct fwk_element *rcar4_power_domain_get_element_table
    (fwk_id_t module_id)
{
    return create_power_domain_element_table(
        rcar4_core_get_count(),
        rcar4_cluster_get_count(),
        FWK_MODULE_IDX_RCAR4_PD_CORE,
        0,
        ...
        rcar4_power_domain_static_element_table,
        FWK_ARRAY_SIZE(rcar4_power_domain_static_element_table));
}
...
struct fwk_module_config config_power_domain = {
    .elements = FWK_MODULE_DYNAMIC_ELEMENTS(rcar4_power_domain_get_element_table),
    .data = &rcar4_power_domain_config,
};
